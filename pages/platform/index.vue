...
const headers = computed(() => [
    ...
    { title: t('platform.created_by'), align: 'start' as const, key: 'addby' },
    { title: t('platform.updated_by'), align: 'start' as const, key: 'updateby' },
    { title: t('platform.created_at'), align: 'start' as const, key: 'createdAt' },
    { title: t('platform.updated_at'), align: 'start' as const, key: 'updatedAt' },
...
const filteredPlatforms = computed(() => {
    ...
    return platforms.value.filter(platform =>
        platform.platform_id.toLowerCase().includes(searchQuery.value.toLowerCase()) ||
        platform.platform_name.toLowerCase().includes(searchQuery.value.toLowerCase())
    );
});
